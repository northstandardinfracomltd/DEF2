...
const translations = {
  'Français': {
    ...
    paymentDisclaimer: "Paiement sécurisé par carte bancaire ou Paypal, pour un paiement sur présentation facture avec virement bancaire, veuillez nous contacter. Vous payerez aujourd'hui le premier mois (310€ TTC) ainsi que le frais d'activation (une seule fois) de 500€ TTC. En continuant, vous acceptez nos",
  ...
  'English': {
    ...
    paymentDisclaimer: "Secure payment by credit card or Paypal, for payment on invoice presentation with bank transfer, please contact us. You will pay the first month (€310 incl. tax) today as well as the activation fee (one-time) of €500 incl. tax. By continuing, you accept our",
    eula: "EULA terms",
  ...
  'Deutsch': {
    ...
    paymentDisclaimer: "Sichere Zahlung per Kreditkarte oder Paypal. Für Zahlungen auf Rechnung mit Banküberweisung kontaktieren Sie uns bitte. Sie zahlen heute den ersten Monat (310 € inkl. MwSt.) sowie die Aktivierungsgebühr (einmalig) von 500 € inkl. MwSt. Indem Sie fortfahren, akzeptieren Sie unsere",
  ...
  'Português': {
    ...
    paymentDisclaimer: "Pagamento seguro por cartão de crédito ou Paypal. Para pagamento por fatura com transferência bancária, entre em contato conosco. Você pagará hoje o primeiro mês (€310 com impostos) e a taxa de ativação única de €500 com impostos. Ao continuar, você aceita os nossos",
    eula: "termos do EULA",
  ...
  'Español': {
    ...
    paymentDisclaimer: "Pago seguro con tarjeta bancaria o Paypal, para un pago contra factura con transferencia bancaria, póngase en contacto con nosotros. Pagará hoy el primer mes (310 € IVA incluido) así como la tasa de activación única de 500 € IVA incluido. Al continuar, acepta nuestras",
