...
export async function triggerEmail6RapportIntervention(
  ...
  const body = `Un document a été généré pour l’intervention effectuée sur votre défibrillateur ${defibIdentifiant} le ${dateStr}. Connectez-vous sur votre portail client pour le télécharger.`;
